...
kafka_config = {
    ...
    'sasl.username': 'QCT5V3W7ILP4O5ZZ',
    'sasl.password': 'cfltlsB2WG113Ff2S9Fxjv4v6BmSaDB88w/d+nPjCW4YCt5S1GQF/d12gVugApBQ'
}

schema_registry_client = SchemaRegistryClient({
  'url': 'https://psrc-zjovo6o.centralindia.azure.confluent.cloud',
  'basic.auth.user.info': '{}:{}'.format('45Y575A7HSGQCYB6', 'cfltyClsuS1oacMsbyrIgZdTPutOJJD0OOTdQf9sllDrmRhwsMMHhTFQqUsCLJow')
})
